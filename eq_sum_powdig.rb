...
def eq_sum_powdig(h_max, exp)
  (2..h_max).select{
    |num| num.to_s.split('').inject(0){ |n,v| n += v.to_i**exp} == num
  }
end

# Quick test
puts eq_sum_powdig(100, 2) == []
puts eq_sum_powdig(1000, 2) == []
puts eq_sum_powdig(2000, 2) == []
puts eq_sum_powdig(200, 3) == [153]
puts eq_sum_powdig(370, 3) == [153, 370]
